            ...
            <div className="flex-1 space-y-6 lg:space-y-7">
              ...
              <div className="flex flex-col sm:flex-row gap-5 sm:items-center pt-6 lg:pt-7 border-t border-neutral-200 dark:border-neutral-800">
                <div className="flex -space-x-3">
                  <img 
                    src="https://randomuser.me/api/portraits/women/21.jpg" alt="User" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900 object-cover' 
                  />
                  <img 
                    src="https://randomuser.me/api/portraits/men/12.jpg" alt="User" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900 object-cover' 
                  />
                  <img 
                    src="https://randomuser.me/api/portraits/women/24.jpg" alt="User" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900 object-cover' 
                  />
