  ...
  return (
    <div className="isolate">
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 -left-1/4 size-1/2 bg-amber-400 dark:bg-amber-500 rounded-full blur-3xl opacity-20"></div>
      </div>
      <div className="container mx-auto px-6 py-20 md:py-24 lg:px-16 lg:py-28 xl:py-32">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
          <div className="flex-1 space-y-6 lg:space-y-7">
            ...
            <div className="flex flex-wrap gap-3 lg:gap-4">
              ...
              <button className="px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-900 dark:text-white font-medium flex items-center transition group border border-neutral-300 dark:border-neutral-700">
              ...
              <div className="relative bg-white dark:bg-neutral-900 p-4 lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800">
                <div className="flex items-center justify-between mb-3 lg:mb-4">
                  <div className="flex items-center gap-2">
                    <span className="size-2.5 lg:size-3 rounded-full bg-red-500"></span>
                    <span className="size-2.5 lg:size-3 rounded-full bg-amber-500"></span>
                    <span className="size-2.5 lg:size-3 rounded-full bg-green-500"></span>
                  </div>
                ...
                <div className="h-56 md:h-64 lg:h-60 xl:h-72 rounded-lg bg-neutral-100 dark:bg-neutral-800 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-4 right-4">
                    <div className="size-12 lg:size-14 rounded-full bg-gradient-to-r from-amber-500 to-indigo-900 flex items-center justify-center text-white shadow-lg animate-pulse">
                ...
                <div className="mt-3 lg:mt-4 flex justify-between items-center">
                  ...
                  <button className="size-8 lg:size-9 xl:size-10 flex items-center justify-center rounded-full bg-amber-500 text-neutral-900 hover:bg-amber-600 transition">
      ...
      <div className="hidden md:block absolute bottom-8 left-8 lg:bottom-10 lg:left-10 animate-bounce">
        <div className="bg-neutral-900 text-white px-2.5 py-2.5 rounded-lg text-xs lg:text-sm flex items-center shadow-lg">
